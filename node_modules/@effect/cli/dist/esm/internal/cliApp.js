  ...
  return Effect.matchEffect(InternalCommand.parse(self.command, prefixedArgs, config), {
    ...
    onSuccess: Unify.unify(directive => {
      switch (directive._tag) {
        ...
        case "BuiltIn":
          {
            return handleBuiltInOption(self, executable, filteredArgs, directive.option, execute, config, args).pipe(Effect.catchSome(e => InternalValidationError.isValidationError(e) ? Option.some(Effect.zipRight(printDocs(e.error), Effect.fail(e))) : Option.none()));
          }
      }
    })
  });
