 ...
 * @category models
 */
export type SuccessSchema<R> = R extends Rpc<infer _Tag, infer _Payload, infer _Success, infer _Error, infer _Middleware> ? _Success : never;
/**
 * @since 1.0.0
 * @category models
 */
 ...
 * @category models
 */
export type SuccessExit<R> = SuccessSchema<R> extends infer S ? S extends RpcSchema.Stream<infer _A, infer _E> ? void : Schema.Schema.Type<S> : never;
/**
 * @since 1.0.0
 * @category models
 */
export type SuccessExitEncoded<R> = SuccessSchema<R> extends infer S ? S extends RpcSchema.Stream<infer _A, infer _E> ? void : Schema.Schema.Encoded<S> : never;
/**
 * @since 1.0.0
 * @category models
 */
 ...
 * @category models
 */
export type ErrorExit<R> = SuccessSchema<R> extends RpcSchema.Stream<infer _A, infer _E> ? _E["Type"] | Error<R> : Error<R>;
/**
 * @since 1.0.0
 * @category models
 */
export type ErrorExitEncoded<R> = SuccessSchema<R> extends RpcSchema.Stream<infer _A, infer _E> ? _E["Encoded"] | ErrorEncoded<R> : ErrorEncoded<R>;
/**
 * @since 1.0.0
 * @category models
 */
